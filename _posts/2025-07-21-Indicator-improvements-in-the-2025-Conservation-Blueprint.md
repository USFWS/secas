...
Here’s a sneak peek at Blueprint indicator improvements for 2025.<!--more--> When the Blueprint is released in October, the indicators will be up on the SECAS Atlas, Blueprint Explorer, and publicly available to download (along with the detailed documentation and code). 
