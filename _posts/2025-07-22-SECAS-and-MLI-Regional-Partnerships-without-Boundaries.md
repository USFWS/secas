...
The comfort of familiarity is a common thread through many aspects of our personal lives. In social settings we naturally gravitate to people were familiar with. When encountering new and different people, we can often find common ground based on shared values, familiar interests, and experiences. This is a basic concept of how relationships are formed and makes the imaginary lines that separate us seem a bit trivial. 
