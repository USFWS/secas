...
hero:
  ...
  float: right
---
There was a recent paper in Science about [butterfly declines in the United states from 2000-2020](https://www.science.org/doi/10.1126/science.adp4671). The data comes from >76,000 surveys from 35 different monitoring programs. I dug a little deeper into the trends in the Southeast. I figured I'd share some of the things that I found interesting. Apologies to folks in Texas, Oklahoma, Missouri, Virginia, Puerto Rico, and the U.S. Virgin Islands, because the paper's "Southeast" region didn't include those states and territories. It did include most SECAS states, though!<!--more-->
