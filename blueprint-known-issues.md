...
- Some parts of small, low-elevation islands are underprioritized. The exact boundaries of these highly dynamic islands can be hard to predict. The boundaries used in the islands indicator and areas used for critical habitat of key island species don’t always align perfectly—especially in the most dynamic parts of the island. A potential improvement to address this is under investigation. Examples include Tybee Bar in GA, Crab Bank Seabird Sanctuary in SC, Lanark Reef in FL, and the Chandeleur Islands off of LA.
- Some recently developed areas are overprioritized (e.g., a solar field near Wedgefield, FL; a limestone barren west of Lime, TN; and the Moncure Megasite in NC). Updated landcover and indicator updates based on newer landcover should fix this issue.
...
- Some important urban natural areas are underprioritized. Examples include Kapok Park in Clearwater, FL; the West Atlanta Watershed Alliance education hub in Atlanta, GA; Lost Corner Preserve in Sandy Springs, GA; and Blucher Park in Corpus Christi, TX. Improvements in indicators related to urban natural areas could fix this in the future.
- Parts of some larger natural areas, especially forested areas, near urban centers are underprioritized (e.g., the Western Highland Rim in Nashville, TN; the ridge south of Elkins, WV; and Rocky Face Ridge in Dalton, GA). Improving how the indicators address the role these areas play in connecting people to nature and providing climate change solutions to urban areas, as well as updated corridor methods, could help address this in the future.
- Some ridges in the Ridge and Valley ecoregion are underprioritized. Future indicator improvements should fit this.
...
- Some sandy ridges with significant longleaf restoration potential and importance as movement corridors for longleaf-associated species are underprioritized. Examples include the Trail Ridge area east of Okefenokee Swamp in GA and a sand ridge off of Hwy 421 northwest of Wilmington, NC. Improvements in indicators and prioritization methods could improve this in the future.
...
- Some recently strip-mined areas are overprioritized (e.g., the area north of Mount Hope, AL). These areas scored highly in resilient terrestrial sites, but that analysis was done before the mining occurred. Future updates to resilient terrestrial sites could fix this. If the areas are restored after mining is complete, indicators like grasslands and savannas could pick up any restored conditions.
...
- Some urban areas are overprioritized due to issues with the potential access to parks indicator (e.g. areas east of Sarasota, FL; part of western Winter Garden, FL). This indicator identifies areas where parks are needed but does not consider whether a site is available to become a park. It includes areas of low intensity development in order to capture vacant lots, which can serve as new park opportunities. However, as a result, this indicator also captures some areas that are already used for another purpose (e.g., houses, cemeteries, and businesses) and are unlikely to become parks.
- Some dirt roads through forests are overprioritized based on the grasslands and savannas indicator (e.g., a road northwest of Hawthorne, FL). The mix of sparse tree cover and sandy soil in the pixel can look like a savanna. This can also cause speckling of priorities—especially in northern FL and southern GA and AL.
- Some narrow powerline rights-of-way and roadsides important for sun-loving plants of high conservation concern are underprioritized. Improved methods for the grasslands and savannas indicator could fix this in the future.
- Some mowed areas on military installations are overprioritized based on the grasslands and savannas indicator (e.g., parts of Camp Robinson in AR and Milan Army Ammunition Plant in TN).
- Some greenways and trails are overprioritized in areas where those trails degrade important habitat (e.g., trails in Bastrop State Park, TX and their impacts on Houston toad habitat).
- Greenways and trails missing from OpenStreetMap are underprioritized (e.g., Bayport Berm in Seabrook, TX). This will likely be fixed with future indicator updates.
- There are some overprioritized speckles in highly developed areas due to issues with the greenways and trails indicator (e.g., North Raleigh, NC and NorthPark Center mall in Dallas, TX). Future indicator improvements could fix this.
- At least one private easement southwest of Frankfort, KY is overprioritized due to its inclusion in the urban park size indicator. We will investigate ways to better exclude private easements from this indicator in the next update.

#### Wetlands  
- Some important wetlands are underpriorized. Examples include the east and west sides of Felsenthal National Wildlife Refuge in AR; Ten Mile Pond Conservation Area in MO; the southeast part of Big Oak Tree State Park in MO; bottomland hardwood and xerohydric flatwoods in Clarks River National Wildlife Refuge in KY; white fringeless orchid habitat in Daniel Boone National Forest in KY; wetlands just east of Macedonia, TN; depressional wetlands southeast of Raeford, NC; the Stony Run wetlands in northeast Dunn, NC; and marshes in a TNC conservation easement off of Port Bay in TX. Improvements to indicators and prioritization methods could fix these in the future.
...
- Sections of the Everglades on either side of U.S. Hwy 41 are underprioritized. Indicator improvements under investigation could fix this in the future.
...
- Some areas along the shores of small lakes that are surrounded by development or agriculture are underprioritized (e.g., Long Lake, Lake Lawne, and Island Lake in northern Orlando, FL; a historic wood stork colony northeast of Lake Poinsett in FL; a wood stork colony north of Sawgrass Lake in FL; wetlands northwest of Lake Apopka and Lake Harris in FL; and a sandhill crane roost east of Palm Bay, FL). These areas can provide important habitat for waterbirds and corridors for species like bobcat.
- Some coastal wetlands in the coverage gap between resilient coastal sites and resilient terrestrial sites are underprioritized (e.g., Jamestown, VA).
...
- Some Florida panther habitat that is important for breeding and movement in South FL is underprioritized (e.g., north of Spirit-of-the-Wild Wildlife Management Area).
...
- Some habitat for cave and karst species is being underprioritized (e.g., Ozark cave fish habitat in Republic, MO and a watershed north of Key Cave in AL).
- Some habitat for range-restricted plants is underprioritized (e.g., an area southwest of Manning, GA).
...
- Some streams are overprioritized due to lack of information on local hydrologic alterations (e.g., a stream just south of Bastrop State Park in TX).
- Some streams where major restoration targets benefit downstream users are underprioritized (e.g., the headwaters of the Alum Fork - Upper Saline River watershed in AR).
- Some sections of small streams are underprioritized where the estimated floodplain map doesn’t include them (e.g., parts of Upper Crabtree Creek in Durham, NC). Improvements to freshwater indicators to better capture small streams should fix this in the future.
...
- Some important hardbottom and coral areas are underprioritized in the Atlantic (e.g., parts of Gray’s Reef in GA, part of the Savannah Banks off of GA, and some corals in Southeast FL). Future indicator updates could fix this.
- Some paleo channels are underprioritized. These areas that were historically freshwater rivers have significant archeological value. No indicator currently targets paleo channel locations.
...
- Some salt ponds, which provide important habitat for birds and other species, are underprioritized.
...
- Some areas that are important for coquí species in PR are underprioritized (e.g., Puerto Rican rock frog _[Eleutherodcactylus cooki]_ habitat near water in Southeast PR). Work on a coquí-specific indicator is ongoing.
- Habitat important for the Virgin Islands boa on the east side of St. Thomas and potential future habitat on Savana Island is underprioritized. Improvements in prioritization methods should fix this soon.
