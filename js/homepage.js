...
buf.push("<li class=\"search-result\"><a" + (jade.attr("href", result.url, true, false)) + "><h2>" + (jade.escape(null == (jade_interp = result.title) ? "" : jade_interp)) + "</h2></a><ul class=\"result-tags\">");
// iterate result.tags
;(function(){
  var $$obj = result.tags;
  if ('number' == typeof $$obj.length) {
