...
<figure class="flex flex-col gap-2 mb-12 items-center">
  <enhanced:img src="$images/BlueprintUserChart_4-2-26.png" alt="A pie chart showing usage of the Blueprint: Nonprofit: 29%, Partnership: 21%, State: 17%, Federal: 7%, Local: 6%, Private: 11%, Academic: 8%, Tribal: 1%" class="max-w-[360px] self-center border-none"/>
