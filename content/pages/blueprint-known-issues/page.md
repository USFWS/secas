...
Here are the known issues identified with Southeast Conservation Blueprint 2025:
...
- Some managed private grasslands are underprioritized. Examples include Prairie Wildlife grasslands west of Vinton, MS; an area southeast of Guadalupe Mountains National Park in TX; East Foundation lands in South TX; grasslands of special significance southeast of Starkville, MS and northwest of Egypt, MS; and a grassland restoration area northeast of Starkville, MS. Improvements to the fire frequency and grassland indicators could fix this in the future.
- Some managed public grasslands are underprioritized. Examples include multiple prairies in MO (McGee Family Conservation Area, Jerry Smith Park, and Stilwell Prairie). These will likely be fixed in the next version of the Blueprint.
...
- A small set of bottomland forest areas in areas flooded by dams are underprioritized (e.g., the area between Summerfield and Faircloth, LA and the Little River wetlands in Millwood Recreation Area in AR). These areas are misidentified as open water reservoirs in the current reservoir mask used by the landscape condition indicator. Improvements to that mask for future Blueprints are under investigation.
...
- Some areas along the shores of small lakes that are surrounded by development or agriculture are underprioritized (e.g., Lake Lawne in northern Orlando, FL; a historic wood stork colony northeast of Lake Poinsett in FL; and a sandhill crane roost east of Palm Bay, FL). These areas can provide important habitat for waterbirds and corridors for species like bobcat.
...
- Some areas that are important for coquí species in PR are underprioritized (e.g., Puerto Rican rock frog (_Eleutherodcactylus cooki_) habitat near water in Southeast PR). Work on a coquí-specific indicator is ongoing.
- Habitat important for the Virgin Islands boa on the east side of St. Thomas is underprioritized. Improvements in prioritization methods should fix this soon.
