...
hero:
  alt: Photo showing mist rising off a salt marsh at St. Simons Island, GA
  caption: 'Salt marsh at St. Simons Island, GA. Photo: George Gentry, USFWS.'
  url: 'https://pixnio.com/nature-landscapes/river/salt-marsh-in-a-tidal-river-estuary'
---
...
Through SASMI, the conservation community is rallying around salt marsh and working together to make a greater impact than any one partner could accomplish alone. Using the Southeast Blueprint helps partners find the best places to collaborate to achieve the SASMI goal to maintain and enhance the quality and extent of salt marshes, even in the face of future change. For example, [the SASMI implementation team for SC](https://storymaps.arcgis.com/stories/c983e708450d49ae93fd276bb89d49c0)--which includes 100 members representing a wide range of sectors--is using the Blueprint to strategically prioritize parcels for protection within the state. In addition, National Wildlife Refuges are using the Blueprint to plan for how future land protection can best advance the SASMI goal while also supporting high quality habitat and public recreation.
