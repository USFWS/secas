...
A few years ago, when I joined the U.S. Fish and Wildlife Service, the first project I was tasked with overseeing and assisting was a social network analysis (SNA) for the Southeast Conservation Adaptation Strategy (SECAS). The 2021 [SECAS Futures report](/pdf/SECAS_Futures_final_report_March_2021.pdf) recommended conducting this analysis as a tool to increase connections and deepen engagement with other regional forums and partners by helping SECAS better understand existing relationships and connections.
