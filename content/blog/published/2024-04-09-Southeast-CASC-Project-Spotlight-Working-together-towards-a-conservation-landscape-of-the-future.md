...
<figure class="flex flex-col items-center">
  <enhanced:img src="$images/SECAS Blueprint Screenshot Raleigh.png?enhanced&format=avif;png" alt="Screenshot of Southeast Conservation Blueprint, zoomed in on Raleigh, NC" class="w-auto max-w-[600px]"/>
...
To date, the Blueprint [has been used by](/organizations-using-the-blueprint/) more than 350 people from over 140 organizations across the Southeast to [bring in new funding and inform conservation and planning decisions](/story-map/). For example, Morris and Terando traveled together to give a presentation to [Ten at the Top](https://tenatthetop.org/), a community organization of ten counties in upstate South Carolina.
