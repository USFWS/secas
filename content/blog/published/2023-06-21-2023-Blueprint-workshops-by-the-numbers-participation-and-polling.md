...
<figure class="flex flex-col items-center">
  <enhanced:img src="$images/Blueprint2023Workshop_Poll1Results_600p.png?enhanced&format=avif;png" alt="A pie chart with polling results showing the following percentages of the vote - continental 65%, mainland 17%, other 8%, contiguous 10%." class="w-auto max-w-[600px]"/>
...
<figure class="flex flex-col items-center">
  <enhanced:img src="$images/Blueprint2023Workshop_Poll2Results_600p.png?enhanced&format=avif;png" alt="A pie chart with polling results showing the following percentages of the vote - Both/full Southeast Blueprint 48%, continental Southeast only 31%, Caribbean only 19%, and neither 2%."  class="w-auto max-w-[600px]"/>
...
<figure class="flex flex-col items-center">
  <enhanced:img src="$images/Blueprint2023Workshop_Poll3Results_600p.png?enhanced&format=avif;png" alt="A pie chart with polling results showing the following percentages of the vote - No it's easy 55%, Yes it's difficult 28%, N/A 8%, and I don't know 9%." class="w-auto max-w-[600px]"/>
