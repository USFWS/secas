...
Participants enjoyed being able to see the Blueprint in action using [the Blueprint Explorer](https://blueprint.geoplatform.gov/southeast/) to zoom into their areas of interest to see how they score and get a direct view of where they fit into a larger picture. They were also interested to learn how the Blueprint is free to anyone and can be used as an additional resource to inform their management and to assist if their groups pursue project funding. As a reminder, if you’d like help using the Blueprint, you can find contact information for user support staff [on the SECAS staff page](/staff/).
