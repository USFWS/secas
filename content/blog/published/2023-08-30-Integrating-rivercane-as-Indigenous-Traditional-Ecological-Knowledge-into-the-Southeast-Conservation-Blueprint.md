...
<figure class="flex flex-col items-center">
  <enhanced:img src="$images/RivercaneBasket.jpg?enhanced&format=avif;jpg" alt="Young man sits on a bench watching an older woman demonstrate rivercane techniques." class="w-auto max-w-[600px]"/>
...
<figure class="flex flex-col items-center">
  <enhanced:img src="$images/RivercaneTeam.png?enhanced&format=avif;png" alt="Smiling faces in a videoconferencing call." class="w-auto max-w-[600px]"/>
