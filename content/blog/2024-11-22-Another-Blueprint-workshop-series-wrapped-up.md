...
<figure class="flex flex-col items-center">
  <enhanced:img src="$images/Blueprint2024WorkshopSectorChart_sm.png" alt="Pie chart of attendees by sector, showing 22% federal, 30% state, 30% nonprofit, 1% Tribal, 1% local, 5% private, 4% academic, and 7% partnership." class="max-w-[400px]" />
