...
const url = 'https://cors-anywhere.herokuapp.com/https://www.fws.gov/southeast/articles/index.js';
const list = document.querySelector('.newsroom-list');

const filterSecasContent = res => res.data.filter(article => article.tags && includes(article.tags, 'Southeast Conservation Adaptation Strategy'));
